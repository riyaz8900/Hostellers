            ...
            <div className='container  mx-auto py-5 px-3  flex justify-between items-center'>
                ...
                <div className='hidden md:block lg:block'>
                    <ul className='flex gap-3 items-center text-lg'>
                        ...
                        <li><Link to="/destination" className="block px-4 py-2 cursor-pointer ">Destinations</Link></li>
                ...
                >
                    ...
                    <ul className="flex flex-col gap-4 p-4 text-lg">
                        <li><Link to="/journey" className="block px-4 py-2 " onClick={() => setMenuOpen(false)} >Journey</Link></li>

                        <li>Hostel</li>
                        <li><Link to="/destination" className="block px-4 py-2 cursor-pointer hover:bg-gray-100 " onClick={() => setMenuOpen(false)} >Destinations</Link></li>
                     
                                                <li><Link to="/workstation" className="block px-4 py-2 " onClick={() => setMenuOpen(false)} >Work Stations</Link></li>

                        <li><Link to="/events" className="block px-4 py-2 " onClick={() => setMenuOpen(false)} >Events</Link></li>
                                                                        <li><Link to="/groups" className="block px-4 py-2 " onClick={() => setMenuOpen(false)} >Groups</Link></li>

                        <li><Link to="/register" className="block px-4 py-2 hover:bg-gray-100 " onClick={() => setMenuOpen(false)} >Signup</Link></li>
                        <li><Link to="/login" className="block px-4 py-2 hover:bg-gray-100 " onClick={() => setMenuOpen(false)} >SignIn</Link></li>
